...
function fetchForms() {
  ...
  fetch("/forms", {
    ...
    .then((forms) => {
      ...
      if (forms.length === 0) {
        container.innerHTML = '<div class="empty-state">No forms found. Create your first form!</div>';
        return;
      }
      ...
      forms.forEach((form) => {
        ...
        formCard.innerHTML = `
          ...
          <div class="form-actions">
            <button class="btn btn-secondary btn-sm" onclick="editForm(${form.id})">
              <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
              </svg>
              Edit
            </button>
            <button class="btn btn-secondary btn-sm" onclick="deleteForm(${form.id})">
              <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
              </svg>
              Delete
            </button>
            <button class="btn btn-primary btn-sm" onclick="viewSubmissions(${form.id})">
              <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
